...
- [x] Home page video card: median response words — "X w median" in teal-400/40, variable chatMRW
- [x] Build verification PASSED
...
- [x] Home page video card: user word diversity — "X unique words" in teal-400/40, variable chatUWD, counts unique words across user messages (>=4 msgs, >=20 unique)
- [x] Build verification PASSED
...
- [x] HomePage: avg question length — "avg X w/q" in indigo-400/40, variable chatAQ
- [x] Build verification PASSED
...
- [x] HomePage: shortest question badge — "X min q-words" in slate-400/40, variable chatSQ
- [x] Build verification PASSED

### Wave 176 — Numerical reference detection, conditional badge, max question length
- [x] TranscriptPanel: numerical reference detection — "#" in blue-400/30, regex `/\b(\d{4}|\d+%|\$\d+|\d+\.\d+)\b/`
- [x] ChatOverlay: conditional language badge — "conditional" in purple-500/10, detects if/unless/assuming language
- [x] HomePage: max question length badge — "X max q-words" in orange-400/40, longest user question word count (variable `chatMQ`)
- [x] Build verification PASSED
